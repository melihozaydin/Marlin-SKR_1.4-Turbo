...
#define STRING_CONFIG_H_AUTHOR "(Melih Özaydın, SKR 1.4 Turbo, 30.01.2022)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Kamil-3D"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -40, -23, -0.4 }
