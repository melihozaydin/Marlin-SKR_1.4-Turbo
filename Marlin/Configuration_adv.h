 ...
 */
  ...
  #define PROBING_MARGIN_LEFT PROBING_MARGIN // 31 mm in from left edge
  #define PROBING_MARGIN_RIGHT PROBING_MARGIN // 15
  #define PROBING_MARGIN_FRONT PROBING_MARGIN // 9 
  #define PROBING_MARGIN_BACK PROBING_MARGIN // 4
#endif
